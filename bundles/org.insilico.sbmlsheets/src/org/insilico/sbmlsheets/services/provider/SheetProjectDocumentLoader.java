...
@Component(service = IContextFunction.class,
        property = {"service.context.key=org.insilico.sbmlsheets.core.SheetProject"})
public class SheetProjectDocumentLoader extends ContextFunction{
	
    // Stores weak reference to already loaded documents.
    Map<String, SheetProject> cache = new WeakHashMap<>();
    ...
    public Object compute(IEclipseContext context, String contextKey) {
        ...
        if (urlVal != null && urlVal instanceof String) {
            ...
            // Check cache
            SheetProject doc = cache.get(urlString);
